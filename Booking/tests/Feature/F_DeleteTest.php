...
class F_DeleteTest extends TestCase
{

    public function test_delete_booking()
    {
        $response = $this->delete('http://127.0.0.1:8000/api/booking/'.E_BookingTest::$booking_id);
    ...
    {
        $response = $this->delete('http://127.0.0.1:8000/api/cabinet/'.D_CabinetTest::$cabinet_id);
        $response->assertStatus(204);
    }
    ...
    {
        $response = $this->delete('http://127.0.0.1:8000/api/city/'.B_CityTest::$city_id);
        $response->assertStatus(204);
    }
